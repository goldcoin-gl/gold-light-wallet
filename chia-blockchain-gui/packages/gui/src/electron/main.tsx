  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'Website：www.gold.cab' }),
            click: () => {
              openExternal(
                'https://www.gold.cab/',
              );
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/goldcoin-gl/gold-blockchain/releases',
              );
            },
          },
          {
          ...
          {
            label: i18n._(/* i18n */ { id: 'Gold Staking Calculator' }),
            click: () => {
              openExternal(
                'https://www.gold.cab/calculator/index.html',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/goldcoin-gl/gold-blockchain/issues',
              );
            },
          },
          {
    ...
    if (process.platform === 'darwin') {
      // Gold Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Chia' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Gold Blockchain' }),
            click: () => {
              openAbout();
            },
          },
