...
This library provides support for TypeScript/JavaScript [Chia](https://www.chia.net) apps to access the [Gold Blockchain RPC](https://github.com/Chia-Network/chia-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Gold Blockchain RPC.
